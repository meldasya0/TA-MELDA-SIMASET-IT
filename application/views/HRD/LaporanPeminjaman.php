...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div>
                <form method="POST" action="<?= base_url("IT/Laporan/exportPeminjaman") ?>">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="tanggal_mulai">Mulai - Tanggal Peminjaman</label>
                            <input type="date" class="form-control" id="tanggal_mulai" name="tanggal_mulai">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="tanggal_akhir">Akhir - Tanggal Peminjaman</label>
