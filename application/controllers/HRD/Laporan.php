...
class Laporan extends CI_Controller {    
    ...
    public function index()
	{
        ...
        $this->load->view('HRD/LaporanAset',$data);
    ...
    public function exportAset()
	{
        ...
        $this->load->view('templates/header');
        $this->load->view('HRD/LaporanAsetExport',$data);
	}
    public function Perbaikan()
	{
        ...
        $this->load->view('templates/sidebar-hrd');
        $this->load->view('templates/topbar');
        $this->load->view('HRD/LaporanPerbaikan',$data);
        $this->load->view('templates/footer');
	}
    public function exportPerbaikan()
	{
        ...
        $this->load->view('templates/header');
        $this->load->view('HRD/LaporanPerbaikanExport',$data);
	}
    public function Peminjaman()
	{
        ...
        $this->load->view('templates/sidebar-hrd');
        $this->load->view('templates/topbar');
        $this->load->view('HRD/LaporanPeminjaman',$data);
        $this->load->view('templates/footer');
	}
    public function exportPeminjaman()
	{
        ...
        $this->load->view('templates/header');
        $this->load->view('HRD/LaporanPeminjamanExport',$data);
	}
}
